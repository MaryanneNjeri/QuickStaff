          ...
          <Card style={styles.call} transparent>
            <Body>
              <Text note style={{ fontSize: 10 }}>
                {' '}
                <Icon type="FontAwesome" name="money" style={{ fontSize: 10 }} />
                {' '}
pay rate
              </Text>
              <Text>{' '}</Text>
          ...
          <Card style={styles.call} transparent>
            <Body>
              <Text note style={{ fontSize: 10 }}>
                {' '}
                <Icon type="Entypo" name="location-pin" style={{ fontSize: 10 }} />
                {' '}
City
              </Text>
              <Text />
          ...
          <Card style={styles.call} transparent>
            <Body>
              <Text note style={{ fontSize: 10 }}>
                {' '}
                <Icon type="MaterialCommunityIcons" name="map" style={{ fontSize: 10 }} />
                {' '}
Province
              </Text>
              <Text />
          ...
          <Card style={styles.call} transparent>
            <Body>
              <Text note style={{ fontSize: 10 }}>
                <Icon type="Ionicons" name="md-time" style={{ fontSize: 10 }} />
                {' '}
Timezone
              </Text>
              <Text />
